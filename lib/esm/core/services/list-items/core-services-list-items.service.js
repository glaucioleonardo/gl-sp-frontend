        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, pnp.sp.web.lists.getByTitle(listName).items.select(fields).get()];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        reason_1 = _a.sent();
                        error = SpCore.onError(reason_1);
                        SpCore.showErrorLog(reason_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, pnp.sp.web.lists.getByTitle(listName).items.getById(listItemId).select(fields).get()];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        reason_2 = _a.sent();
                        error = SpCore.onError(reason_2);
                        SpCore.showErrorLog(reason_2);
                        throw new Error(error.code.toString());
                    case 4: return [2 /*return*/];
                }
            });

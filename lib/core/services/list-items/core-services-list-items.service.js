...
import { ArrayRemove, AttachmentIcon } from 'gl-w-frontend';
    ...
    retrieveExternal(listName, fieldsArray = [], baseUrl, top = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let count = top;
                if (top == null || top === 0) {
                    const result = yield fetch(listUrl, SpCore.fetchHeader());
                ...
                const resultItems = yield fetch(itemsUrl, SpCore.fetchHeader());

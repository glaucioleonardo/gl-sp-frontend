...
declare class Attachment {
    ...
    setTxtContent(listItemId: number, listName: string, fileName: string | undefined, content: string, baseUrl?: string): Promise<AttachmentFile>;
    addTxtContent(listItemId: number, listName: string, fileName: string | undefined, content: string, baseUrl?: string): Promise<AttachmentFileAddResult>;
}

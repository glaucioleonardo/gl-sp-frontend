...
var gl_w_frontend_1 = require("gl-w-frontend");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, sp_pnp_js_1.default.sp.web.lists.getByTitle(listName).items.select(fields).get()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, sp_pnp_js_1.default.sp.web.lists.getByTitle(listName).items.getById(listItemId).select(fields).get()];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        reason_2 = _a.sent();
                        ...
                        try {
                            for (attachmentList_1 = __values(attachmentList), attachmentList_1_1 = attachmentList_1.next(); !attachmentList_1_1.done; attachmentList_1_1 = attachmentList_1.next()) {
                                ...
                                file = {
                                    ...
                                    url: url,
                                    icon: gl_w_frontend_1.AttachmentIcon.get(attachment.FileName)
                                };

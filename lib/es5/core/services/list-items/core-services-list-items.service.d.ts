...
declare class Attachment {
    ...
    setTxtContent(listItemId: number, listName: string, fileName: string, content: string): Promise<AttachmentFile>;
    addTxtContent(listItemId: number, listName: string, fileName: string, content: string): Promise<AttachmentFileAddResult>;
}

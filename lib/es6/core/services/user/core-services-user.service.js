...
class Core {
    currentUser(baseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield pnp.sp.configure(SpCore.config, base).web.currentUser.get();
            }
            catch (reason) {
...
class Permissions {
    ...
    isInGroup(groupName, userEmail, baseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            const base = baseUrl == null ? SpCore.baseUrl : baseUrl;
            try {
                const user = yield pnp.sp.configure(SpCore.config, base).web.siteGroups.getByName(groupName).users.getByEmail(userEmail).get();
